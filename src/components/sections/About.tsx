      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="mt-12 grid gap-12 md:grid-cols-2">
          ...
          <div className="about-line space-y-4">
            ...
            <div className="glass rounded-2xl p-6"><p className="text-xs uppercase tracking-widest text-muted-foreground">Currently</p><p className="mt-2 font-semibold">Research Intern @ CyberPeace Foundation</p><p className="mt-1 text-sm text-muted-foreground">Building VaultZero (zero-knowledge password manager) & Clarifact (AI fact-checker extension)</p></div>
